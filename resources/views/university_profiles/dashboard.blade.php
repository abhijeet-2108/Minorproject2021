    ...
    <div class="row">
        <div class="col-9 pt-5">
            <div class="d-flex justify-content-between align-items-baseline">
                <div class=" col-12"><h3 style="font-family: 'Comic Sans MS'"><strong>Applicants</strong>
                    </h3></div>
...
{{--        <div class="col-9 pt-5">--}}
{{--            <div class="d-flex justify-content-between align-items-baseline">--}}
{{--                <div class=" col-12"><h3 style="font-family: 'Comic Sans MS'"><strong>Accepted Applications</strong>--}}
{{--                    </h3></div>--}}
