...
{{--                <div class=" col-12"><h3 style="font-family: 'Comic Sans MS'"><strong>Applications</strong>--}}
{{--                    </h3></div>--}}
...
{{--                        <div class="pr-3">--}}
{{--                            <img src="{{ $application->user->profile->profileImage() }}"--}}
...
{{--                                    --}}{{--                                        @endif--}}
{{--                                    <h2><span--}}
{{--                                            class="text-dark">{{ $application->user->username }}</span>--}}
{{--                                    </h2>--}}
{{--                                </a>--}}
{{--                                <small>--}}
...
{{--    </div>--}}
    <div class="row pl-5 pr-5 pb-5">
        <div class="col-9 pt-5">
            <div class="d-flex justify-content-between align-items-baseline">
                <div class=" col-12"><h1 style="font-family: 'Comic Sans MS'"><strong>Accepted Applications</strong>
                    </h1></div>
    ...
    <div class="pl-5 pr-5 border-dark" style="padding-top: 20px; padding-bottom: 20px; font-family: 'Comic Sans MS'">
        <div class="row">
            ...
            <div class="border rounded border-dark col-9 py-3" style="height: auto ">
                @foreach($applications as $application)
                    @if($application->status == 'Pending' or $application->status == 'Rejected')
                        @continue
                    @endif
